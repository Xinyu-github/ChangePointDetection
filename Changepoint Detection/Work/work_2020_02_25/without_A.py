...
########################################################################
if loadmodel:
    model_dense = tf.keras.models.load_model('dense_withoutA.h5')
    model_lstm = tf.keras.models.load_model('lstm_withoutA.h5')
    model_bilstm = tf.keras.models.load_model('bilstm_withoutA.h5')


else:
    # Feedforward Dense NN
    model_dense = tf.keras.models.Sequential()
    model_dense.add(tf.keras.layers.Dense(8, input_dim=8, activation='relu'))
    model_dense.add(tf.keras.layers.Dense(5, activation='relu'))
    model_dense.add(tf.keras.layers.Dense(3, activation='relu'))
